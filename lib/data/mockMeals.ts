...
export const mockMeals: Meal[] = [
  ...
  },
  {
    ...
    description: "Jumbo shrimp sautéed in garlic butter with white wine and fresh herbs",
    price: 24.99,
    category: "Seafood",
  ...
  },
  {
    ...
    description: "Chilean sea bass with crispy skin, served with miso glaze and bok choy",
    price: 34.99,
    category: "Seafood",
  ...
  // Beef
  {
    id: "meal-4",
    name: "Ribeye Steak",
    description: "12oz prime ribeye, grilled to perfection with truffle butter and roasted potatoes",
    price: 42.99,
    category: "Beef",
  ...
  },
  {
    ...
    description: "Tender sliced beef with house-made teriyaki glaze, jasmine rice and vegetables",
    price: 22.99,
    category: "Beef",
  ...
  },
  {
    ...
    description: "Premium beef tenderloin wrapped in pâté and puff pastry, with red wine reduction",
    price: 54.99,
    category: "Beef",
  ...
  // Vegetarian
  {
    ...
    description: "Creamy arborio rice with wild mushrooms, parmesan and fresh truffle oil",
    price: 19.99,
    category: "Vegetarian",
  ...
  },
  {
    ...
    description: "Quinoa with roasted vegetables, feta, hummus and tahini dressing",
    price: 17.99,
    category: "Vegetarian",
  ...
  },
  {
    ...
    description: "Layers of breaded eggplant with marinara sauce and melted mozzarella",
    price: 18.99,
    category: "Vegetarian",
  ...
  },
  {
    ...
    description: "Stir-fried chicken with Thai basil, chilies, and jasmine rice",
    price: 19.99,
    category: "Chicken",
